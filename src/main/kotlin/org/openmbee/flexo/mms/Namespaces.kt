...
object MMS_OBJECT {
    ...
    object ROLE {
        ...
        val AdminBranch = res("AdminBranch")
        val WriteBranch = res("WriteBranch")
        val ReadBranch = res("ReadBranch")
        val AdminLock = res("AdminLock")
        val WriteLock = res("WriteLock")
        val ReadLock = res("ReadLock")
        val AdminScratch = res("AdminScratch")
        val WriteScratch = res("WriteScratch")
        val ReadScratch = res("ReadScratch")
        val AdminArtifact = res("AdminArtifact")
        val WriteArtifact = res("WriteArtifact")
        val ReadArtifact = res("ReadArtifact")
        val AdminCommit = res("AdminCommit")
        val WriteCommit = res("WriteCommit")
        val ReadCommit = res("ReadCommit")
